...
const imagePath = "./assets/lebron.png";
const base64Encode = (filePath: string) => {
  return fs.readFileSync(filePath, { encoding: "base64" });
};

export interface LongTermVisitPass extends v2.OpenAttestationDocument {
  name: string;
  status: PassStatus;
  issuedOn: string;
  expireOn: string;
...
export const longTermVisitPass: LongTermVisitPass = {
